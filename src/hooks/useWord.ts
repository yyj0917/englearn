...
import { type CreateDontknowWordData, type DontknowWord } from '../types/word/word.types'
          ...
          if (payload.eventType === 'INSERT') {
            ...
            setDontknowWords(prev => 
              prev.map(dontknowWord => 
                dontknowWord.id === payload.new.id ? payload.new as DontknowWord : dontknowWord
              )
            )
        ...
        .insert([
          {
            ...
            word_kr: dontknowWordData.word_kr.trim(),
